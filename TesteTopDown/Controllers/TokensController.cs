...
using TesteTopDownApplication.Common;
using TesteTopDownApplication.Tokens.Queries.Generate;
using TesteTopDownContract.Common;
using DomainSubscriptionType = TesteTopDownDomain.Users.SubscriptionType;
